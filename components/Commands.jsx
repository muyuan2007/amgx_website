...
const commands = [{'command': 'warn', 'description':'Give a member warning points.', 'usage': 'a!warn <member> <amount> [reason]', 'permissions': 'kick members, ban members'},
                  {'command': 'unwarn', 'description':'Remove warning points from a member.', 'usage': 'a!unwarn <member> <amount>', 'permissions': 'kick members, ban members'},
                  ...
                  {'command': 'purge', 'description':'Purge up to 500 messages.', 'usage': 'a!purge <amount>', 'permissions': 'manage messages'},
